          ...
          {this.props.cartList.map((item, index) => {
            return (
              <tr key={index}>
                ...
                <td>
                  <button
                    onClick={() => this.props.decrementAmountAsync(item.id)}
                  >
                    异步减少
                  </button>
                  <button onClick={() => this.props.decrementAmount(item.id)}>
                    -
                  </button>
                  <span>{item.amount}</span>
                  <button onClick={() => this.props.incrementAmount(item.id)}>
                    +
                  </button>
                </td>
                <td></td>
